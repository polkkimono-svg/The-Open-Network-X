...
- `ton.md`, §2.2.8–§2.2.10: Block hashes and sha256 assumptions.
- `ton.md`, §2.3.1: 256-bit ECC public keys and account identifiers.
- `ton.md`, §11 (in `INSTRUCTIONS.md`): Cryptographic primitives requirements, domain separation, and deterministic serialization.
