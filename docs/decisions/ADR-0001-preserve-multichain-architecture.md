...
- `ton.md`, §2.1.1--§2.1.5: masterchain, workchain, and shardchain roles.
- `ton.md`, §2.1.8--§2.1.10: shard identity and dynamic sharding.
- `ton.md`, §2.1.13--§2.1.14: masterchain references as global state.
- `ton.md`, §2.7.1--§2.7.9: shard-tree configuration and split/merge behavior.
